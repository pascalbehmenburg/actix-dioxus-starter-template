...
async fn get<R: TodoRepository>(todo_id: web::Path<i32>, repo: web::Data<R>) -> HttpResponse {
...
async fn delete<R: TodoRepository>(todo_id: web::Path<i32>, repo: web::Data<R>) -> HttpResponse {
